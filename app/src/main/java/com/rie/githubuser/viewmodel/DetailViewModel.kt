...
import com.rie.githubuser.repository.FavoriteUserRepository
...
class DetailViewModel(application: Application) : ViewModel() {
    ...
    fun getFavoriteAllUser() : LiveData<List<ItemsSearch>> = mFavoriteUserRepository.getAllFavoriteUser()
    fun getFavoriteUserByUsername(login: String) : LiveData<ItemsSearch> = mFavoriteUserRepository.getFavoriteUserByUsername(login)
